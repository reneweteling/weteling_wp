...
class fyre_widget extends WP_Widget {
...
__('Fyre Feature Widget', 'fabthemes'), 

// Widget description
array( 'description' => __( 'A custom features widget for fyre theme', 'fabthemes' ), ) 
);
}
...
$text = __( 'My custom feature widget', 'fabthemes' );
}
...
<p>
<label for="<?php echo $this->get_field_id( 'icon' ); ?>"><?php _e( 'Icon:','fabthemes' ); ?></label> 
...
<p>
<label for="<?php echo $this->get_field_id( 'text' ); ?>"><?php _e( 'Text:','fabthemes' ); ?></label> 
...
} // Class fyre_widget ends here


// Register and load the widget
function fyre_load_widget() {
	register_widget( 'fyre_widget' );
}
add_action( 'widgets_init', 'fyre_load_widget' );
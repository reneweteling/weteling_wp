...
<div id="welcome-panel" class="about-wrap">
	...
	<p class="about-text"> '.wp_get_theme().' is a free premium WordPress theme. This is a WordPress 3+ ready theme with masonry layout homepage, featured images, widgetized sidebar etc. Theme also comes with an option panel.  </p>
